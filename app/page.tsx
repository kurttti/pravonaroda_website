      ...
      <section className="hero hero-simple" id="top">
        <div className="container hero-simple-grid">
          <div className="hero-copy">
            ...
            <p className="hero-lead">Стали жертвой мошенников? Деньги или ценности похищены, а надежда тает? Мы знаем, как действовать. Мы специализируемся на юридической помощи по возврату похищенных мошенниками денег и имущества. Поможем разобраться в ситуации, выстроить стратегию и пройти все этапы — от заявления в полицию до взыскания средств. Будем добиваться возврата того, что принадлежит вам по праву.</p>
      ...
      <section className="request-section" id="request">
        <div className="container request-grid">
          <div className="request-copy">
            ...
            <p>Оставьте имя, телефон и описание ситуации. После подключения рабочей почты заявки будут приходить напрямую специалисту.</p>
