...
const scenarios = [
  ...
  {
    label: "Типовая ситуация 04",
    title: "Наличные забрал курьер мошенников",
    text: "Фиксируем обстоятельства встречи, добиваемся приобщения записей камер и сведений о курьере, контролируем расследование и оцениваем гражданский иск.",
  },
];
        ...
        <div className="container first-steps-grid">
          ...
          <div className="steps-list">
            <article>
              ...
              <div><h3>Прекратить контакт</h3><p>Не выполняйте новые указания и ничего больше не передавайте. Если курьер ещё в пути или находится рядом, не вступайте с ним в конфликт — сообщите в полицию по номеру 112.</p></div>
            </article>
            <article>
            ...
            <article>
              ...
              <div><h3>Сообщить банку, если он участвовал</h3><p>Если деньги переводили, снимали со счёта или злоумышленники получили доступ к приложению, свяжитесь с банком по официальному номеру и зафиксируйте обстоятельства.</p></div>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className="section cases-section">
        <div className="container">
          <div className="section-heading split-heading cases-heading">
            ...
            <p>Это собирательные примеры, а не обещание результата. Конкретный маршрут зависит от документов, скорости обращения и способа передачи денег.</p>
          </div>
