      ...
      <section className="first-steps" id="first-steps">
        <div className="container first-steps-grid">
          ...
          <div className="steps-list">
            ...
            <article><div className="big-number">03</div><div><h3>Обратиться в полицию</h3><p>Опишите всю хронологию, приложите доказательства и сохраните талон-уведомление и номер КУСП.</p></div></article>
            <article><div className="big-number">04</div><div className="step-contact"><h3>Связаться с нами</h3><p>Юрист уточнит обстоятельства, подскажет, какие материалы собрать в первую очередь, и предложит следующий правовой шаг.</p><a href={`tel:${phone}`}>Позвонить и обсудить ситуацию <span>→</span></a></div></article>
          </div>
        </div>
      </section>
